...
// 🚀 CONSTANTE BASE DE IMAGEN PARA EL FRONT-END
...
const VendedorProductsTable: React.FC<Props> = ({ productos, setProductos }) => {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (editing) {
                // El backend devuelve solo el nombre del archivo (ej. "2.png")
                        ...
                        <div className="mb-3">
                            ...
                            {editing.imagen && !uploading && (
                                <div className="mt-2 border rounded p-2 text-center bg-gray-50">
                                    ...
                                    <img 
                                        // ✅ CORRECCIÓN 1: Agregar /uploads/
                                        src={editing.imagen.startsWith('http') 
                                            ? editing.imagen 
                                            : `${IMAGE_BASE_URL}${editing.imagen}`} 
                                        alt="Preview" 
                                        className="h-32 mx-auto object-contain rounded"
                                        // ✅ CORRECCIÓN 2: Usar el fallback del Backend
                                        onError={(e) => { e.currentTarget.src = `${IMAGE_BASE_URL}no-image.png`; }}
                                    />
