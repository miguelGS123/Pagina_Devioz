...
// 🚀 CONSTANTE BASE DE IMAGEN (INCLUYE LA RUTA NECESARIA)
const IMAGE_BASE_URL = "https://api.devioz.com/uploads/";
const FALLBACK_IMAGE_URL = `${IMAGE_BASE_URL}no-image.png`;
...
const getImageUrl = (imagePath?: string) => {
    ...
    // 🚀 CORRECCIÓN CRÍTICA: Construir la URL completa con IMAGE_BASE_URL
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <img
                                            ...
                                            alt={product.nombre}
                                            onError={(e) => {
                                                // Corregir el fallback para que use la ruta completa
