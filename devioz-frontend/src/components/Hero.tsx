      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 md:px-8">
          <div className="flex justify-between items-start">
            ...
            <div className="w-5/12 text-white mt-32">
              <p className="text-teal-300 font-semibold mb-2 text-lg">
                Tecnología!
              </p>
              ...
              <p className="text-white/85 text-base md:text-[15px] leading-relaxed max-w-lg mb-3 font-bold">
                <strong>
                  Creando el Futuro Digital: Servicios Integrales de Software,
                  IoT, Ciberseguridad, Diseño, Multimedia, Marketing y Más.
                </strong>
              </p>
        ...
        <div className="absolute bottom-[-125px] right-0 left-0 flex justify-center md:justify-end z-30">
          <div className="relative">
            ...
            {/* >>> VIDEO dentro de la pantalla <<< */}
    <div
      // Ajustados los valores para intentar un mejor centrado visual y ajuste
      // Estos valores son aproximados y pueden requerir pequeños tweaks.
      className="absolute top-[5.5%] left-[17%] w-[69%] h-[69%] rounded-md overflow-hidden" // Ligeros ajustes
    >
      <video
        src="/video/video_devioz.mp4"
        controls
        autoPlay
        loop
        muted
